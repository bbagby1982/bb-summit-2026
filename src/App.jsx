...
const SCHEDULE = {
  "Monday, March 9":[
    {time:"1:30 – 2:00 PM",  event:"DM Stockroom Training",                              loc:"Stockroom",                  venue:"🏪"},
    {time:"2:30 – 3:00 PM",  event:"Registration",                                       loc:"Main Lobby",                 venue:"🏛️"},
    {time:"3:00 – 3:15 PM",  event:"CEC Meeting",                                        loc:"Auditorium 12",              venue:"🎬"},
    {time:"3:30 – 4:00 PM",  event:"Arrivals: Dennis, Tyler, Steve, Brittanie",           loc:"Main Lobby",                 venue:"🏛️"},
    {time:"6:00 PM+",        event:"🍽️ Dinner for Evening Guests",                       loc:"Johnnie's Jazz Bar & Grill", venue:"🎷", food:true},
    {time:"6:15 PM",         event:"RealD — Special Guest Dinner",                        loc:"Johnnie's Jazz Bar & Grill", venue:"🎷"},
  ],
  "Tuesday, March 10":[
    {time:"9:15 – 9:30 AM",  event:"☕ Breakfast — Coffee Provided",                     loc:"Hotel",                      venue:"🏨", food:true},
    {time:"9:30 – 9:45 AM",  event:"🚌 Bus Pickup → Liberty Cinema 12",                  loc:"Hotel",                      venue:"🚌"},
    {time:"10:00 – 11:00 AM",event:"CEC Group Meeting (Food & Bar Towns)",                loc:"Auditorium 12",              venue:"🎬"},
    ...
    {time:"1:00 – 1:15 PM",  event:"Vendor Tables Open 🎯",                              loc:"Main Lobby",                 venue:"🏛️"},
    {time:"1:15 – 1:30 PM",  event:"Screenvision Presentation",                           loc:"Auditorium 1",               venue:"🎬"},
    {time:"1:30 – 2:00 PM",  event:"All Company Gathering — Welcome & State of Company",  loc:"Auditorium 1",               venue:"🎬"},
    {time:"2:15 – 3:00 PM",  event:"HR Session",                                          loc:"Auditorium 1",               venue:"🎬"},
    {time:"3:15 – 3:30 PM",  event:"☕ Break",                                            loc:"Lobby",                      venue:"☕"},
    {time:"3:30 – 4:15 PM",  event:"Stock Room Glow Up Session",                                   loc:"Auditorium 1",               venue:"🎬"},
    {time:"4:15 – 4:30 PM",  event:"Scheduling — Amanda Carmichael",                      loc:"Auditorium 1",               venue:"🎬"},
    {time:"4:45 – 5:00 PM",  event:"☕ Break",                                            loc:"Lobby",                      venue:"☕"},
    {time:"5:00 – 5:30 PM",  event:"Training & Development",                              loc:"Auditorium 1",               venue:"🎬"},
    {time:"5:45 – 6:30 PM",  event:"🍕 Pizza Dinner",                                    loc:"Auditorium 1",               venue:"🍕", food:true},
    {time:"6:15 – 6:30 PM",  event:"ScreenX Presentation",                                loc:"Auditorium 1",               venue:"🎬"},
    {time:"6:30 PM+",        event:"Studio Pre-Show & Screening",                         loc:"Auditorium 1",               venue:"🎬"},
    {time:"8:45 PM+",        event:"🎉 After Party & Dessert",                            loc:"Johnnie's Jazz Bar & Grill", venue:"🎷", food:true},
    {time:"9:30 PM",         event:"🚌 Bus Return to Hotel",                              loc:"Hotel",                      venue:"🚌"},
  ],
  "Wednesday, March 11":[
    {time:"9:15 – 9:30 AM",  event:"☕ Breakfast — Coffee at Johnnie's",                 loc:"Johnnie's Jazz Bar & Grill", venue:"🎷", food:true},
    {time:"9:30 – 9:45 AM",  event:"🚌 Bus Pickup → Liberty Cinema 12",                  loc:"Hotel",                      venue:"🚌"},
    ...
    {time:"5:00 – 5:30 PM",  event:"Barco Presentation & Day Wrap Up",                    loc:"Auditorium 1",               venue:"🎬"},
  ...
  "Thursday, March 12":[
    {time:"9:15 – 9:30 AM",  event:"☕ Breakfast — Coffee at Johnnie's",                 loc:"Johnnie's Jazz Bar & Grill", venue:"🎷", food:true},
    {time:"9:30 – 9:45 AM",  event:"🚌 Bus Pickup → Liberty Cinema 12",                  loc:"Hotel",                      venue:"🚌"},
    {time:"10:00 – 10:15 AM",event:"Barco — Opening",                                     loc:"Auditorium 1",               venue:"🎬"},
    {time:"10:15 – 10:30 AM",event:"TAPOS / IT / PCI",                                    loc:"Auditorium 1",               venue:"🎬"},
    {time:"10:45 – 11:00 AM",event:"GDC Speaks",                                          loc:"Auditorium 1",               venue:"🎬"},
    ...
    {time:"1:15 – 1:45 PM",  event:"Hospitality — Paul Farnsworth & Toma Foster",         loc:"Auditorium 1",               venue:"🎬"},
    {time:"1:45 – 2:15 PM",  event:"Programming — Chad Christopher & Ed Carl",            loc:"Auditorium 1",               venue:"🎬"},
    ...
    {time:"3:30 PM+",        event:"🎉 Wrap Up & Safe Travels!",                          loc:"Auditorium 1",               venue:"🎉"},
  ],
};
